...
<body class="font-sans bg-gray-100">
  <div class="flex min-h-screen">
    ...
    <div class="w-full md:w flex items-center justify-center p-8">
      <div class="login-box w-full max-w-md bg-[#f8fafc] rounded-x1 shadow-xl overflow-hidden flex flex-col">
        <!-- Header -->
          <div class="bg-[#fffff] p-6 flex items-center">
            <img
        ...
        <form id="kc-form-login" method="post" action="${url.loginAction}" class="p-8 flex-1">
          ...
          <input
            ...
            type="submit"
            value="Entrar"
            class="w-full bg-[#FF0000] hover:bg-[#3554c0] text-white font-bold py-3 px-4 rounded-lg transition duration-300 ease-in-out"
          />
        </form>
    ...
    <div class="hidden md:flex md:w-1/2 relative items-center justify-center p-12 overflow-hidden"
      ...
      <div class="relative z-10 text-center">
        <h2 class="text-4xl font-bold text-black mb-6">Bem-vindo ao AppBuilder</h2>
        <p class="text-xl text-black-700 mb-8">
          A base para o seu app
        </p>
        ...
        <div class="grid grid-cols-2 gap-6 max-w-lg mx-auto">
          ...
          <img src="${url.resourcesPath}/img/logo-mackcloud.png" alt="MackCloud" />
